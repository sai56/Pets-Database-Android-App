...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listOfPets = (ListView) findViewById(R.id.list);
        ...
        listOfPets.setEmptyView(emptyView);

        mCursorAdapter = new PetCursorAdapter(this,null);
        listOfPets.setAdapter(mCursorAdapter);
    ...
    private void insertPet(){
        ...
        Uri newPet = getContentResolver().insert(PetEntry.CONTENT_URI,contentValues);
        long id = ContentUris.parseId(newPet);
        if(id==-1)
